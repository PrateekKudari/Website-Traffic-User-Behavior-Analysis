...
Understand user behavior across pages and devices

Identify high bounce-rate and low-conversion areas
...
Includes user, session, traffic source, device, page, and conversion data
...
Device and traffic source comparison
...
Product and cart pages have higher drop-off rates
...
Optimize product and cart pages to reduce drop-offs

Focus marketing efforts on high-conversion traffic sources
...
Import cleaned data into SQL for querying
